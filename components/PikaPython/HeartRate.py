...
class Sender():
    ...
    def adv(self,interval_us):
        try:
            ...
            raise OSError
        # return self._ble.gap_advertise(6250,bytearray("adv"),bytes([0x12,0x34,0x56]))
        return self._ble.gap_advertise(6250)
        # return self._ble.gap_advertise(interval_us,connectable=True, adv_data_append=+False)
