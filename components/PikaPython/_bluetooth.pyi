...
class BLE:
    ...
    def advertise_continue(self,interval : int) -> int: ... 
    ...
    # def gatts_notify_all_conn(value_handle : int,data: str, data_len:int) -> int:...
    ...
    # def gatts_indicate_all_conn(value_handle : int,data: str, data_len:int) -> int:...
