...
#ifndef PIKA_MODULE_ESP32_DISABLE
class_def(ESP32){
    __BEFORE_MOETHOD_DEF
};
class_inhert(ESP32, TinyObj);

PikaObj *New_ESP32(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, ESP32);
    return self;
}
#endif
...
#ifndef PIKA_MODULE_MYTEST_DISABLE
void mytest_MYTEST_testMethod(PikaObj *self, Args *args){
    mytest_MYTEST_test(self);
}
method_typedef(
    mytest_MYTEST_test,
    "test", ""
...
class_def(mytest_MYTEST){
    __BEFORE_MOETHOD_DEF
    method_def(mytest_MYTEST_test, 2090756197),
};
class_inhert(mytest_MYTEST, TinyObj);

PikaObj *New_mytest_MYTEST(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, mytest_MYTEST);
    return self;
}

Arg *mytest_MYTEST(PikaObj *self){
    return obj_newObjInPackage(New_mytest_MYTEST);
}
#endif
